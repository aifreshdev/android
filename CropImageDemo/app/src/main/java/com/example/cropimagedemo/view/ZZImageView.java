...
public class ZZImageView extends ImageView implements View.OnTouchListener, ScaleGestureDetector.OnScaleGestureListener,
    ...
    public ZZImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZZImageView(Context context, AttributeSet attrs, int defStyleAttr) {
