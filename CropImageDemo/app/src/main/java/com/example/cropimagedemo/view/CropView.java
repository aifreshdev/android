...
public class CropView extends ImageView {
     ...
     * <p>
     *
     * @param x coordinate from the touchevent
     * @param y coordinate from the touchevent
     ...
     *
     * @param point The new rightBottom Point.
     ...
     * </p>
     *
     * @param x      The X coordinate of the change.
     * @param y      The Y coordinate of the change.
     * @param action The place where the rectangle changed.
     */
     ...
     *
     * @param bitmapDrawable The original bitmap from which the cropped image will be created.
     * @param viewWidth      The width of the View element, needed to calculate rescaling.
     * @param viewHeight     The height of the View element, needed to calculate rescaling.
